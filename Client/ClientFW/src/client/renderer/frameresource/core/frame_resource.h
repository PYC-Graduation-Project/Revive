...
namespace client_fw
{
	...
	private:
		...
		UPtr<SkeletalMeshFrameResource> m_skeletal_mesh_frame_resource;
	...
	public:
		...
		const UPtr<SkeletalMeshFrameResource>& GetSkeletalMeshFrameResource() const { return m_skeletal_mesh_frame_resource; }
