...
namespace client_fw
{
	...
	{
		kOpaqueMaterialMesh, kOpaqueTextureMesh, kOpaqueNormalMapMesh,
		kShapeBox, kTextureBillboard, kOpaqueMaterialBillboard,
		kMaskedMaterialBillboard, kOpaqueWidget, kMaskedWidget
	};
